            ...
            <div className="rounded-xl border border-white/10 bg-white/5 p-4 flex items-start gap-4 transition-colors hover:border-gold-500/30">
                ...
                <div>
                    <label htmlFor="consent" className="text-sm text-slate-300 cursor-pointer select-none block leading-relaxed">
                        ...
                        <br />
                        Нажимая кнопку «Отправить», я соглашаюсь с <a href="/privacy" className="text-gold-400 hover:text-gold-300 underline" target="_blank" rel="noopener noreferrer">Политикой конфиденциальности</a> и даю согласие на сбор и обработку персональных данных.
                    </label>
                </div>
            </div>
        </div>
